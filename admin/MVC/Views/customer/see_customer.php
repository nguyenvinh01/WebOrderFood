        ...
        <div class="card mb-4">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-sm-9">
              <input class="form-control" type="text" name="" value="<?= $data['name'] ?>">
              </div>
            </div>
            <hr>
            <div class="row">
              ...
              <div class="field-form">
                      ...
                      <select class="form-control" name="" title="Giới tính">
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
              <input class="form-control" type="text" name="" value="<?= $data['user_address'] ?>">
              </div>
            </div>
          </div>
        </div>
